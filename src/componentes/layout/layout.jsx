...
// 🟢 NOVO ÍCONE: BoxModel (Representando Cubagem/Veículos)
const BoxModel = ({ size = 24, className = "" }) => (
    ...
    <div className="home-layout">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <NavLink to="/painelatm" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
            <ChartLine size={20} /><span>Tabela Principal</span>
          </NavLink>

          {/* 🟢 NOVO LINK: Medidor de Cargas */}
          <NavLink to="/simulador-veiculo" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
            <BoxModel size={20} /><span>Medidor de Cargas</span>
          </NavLink>
